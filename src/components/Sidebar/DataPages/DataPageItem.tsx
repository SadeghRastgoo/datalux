...
const DataPageItem: FC<dataPageItem> = ({ title, Icon }) => {
  return (
    <li
      draggable
      className="data-page-item grid grid-cols-[25px_1fr_20px] gap-3 items-center hover:text-[#5A6474] text-[#757D8A] py-[.4rem] px-2.5 transition-colors duration-200 hover:bg-white rounded-md cursor-pointer shadow-none hover:shadow-sm hover:shadow-neutral-200 group"
    >
